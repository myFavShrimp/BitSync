...
def minify_template [original_path: string] {
    ...
    let minified = minhtml --do-not-minify-doctype --ensure-spec-compliant-unquoted-attribute-values --keep-spaces-between-attributes --preserve-brace-template-syntax --minify-css --keep-closing-tags $original_path
